...
var OmnishieldContext = createContext(null);
function OmnishieldProvider({
  ...
  return /* @__PURE__ */ jsx(OmnishieldContext.Provider, { value: { engine }, children });
}
...
function useOmnishield() {
  ...
  const getTelemetry = useCallback(() => engine.getTelemetry(), [engine]);
  return {
    secureRequest,
    emergencyStop,
    getTelemetry
...
function SecureAiChatUI({ onPromptAccepted }) {
  ...
  const [shieldStatus, setShieldStatus] = useState("Protected");
  const telemetry = useMemo2(() => getTelemetry(), [messages, getTelemetry]);
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("header", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
          /* @__PURE__ */ jsx2("h2", { style: { margin: 0, fontSize: 18, color: "#F0C040" }, children: "Secure AI Chat" }),
          /* @__PURE__ */ jsxs(
            "span",
            {
              style: {
        ...
        /* @__PURE__ */ jsxs("p", { style: { marginTop: 8, color: "#B8B8C7", fontSize: 13 }, children: [
          "Sanitized Requests: ",
        ...
        /* @__PURE__ */ jsx2(
          "div",
          {
            ...
            children: messages.length === 0 ? /* @__PURE__ */ jsx2("p", { style: { color: "#6F6F82", margin: 0 }, children: "No messages yet. Prompts are sanitized before send." }) : messages.map((message, index) => /* @__PURE__ */ jsx2("p", { style: { margin: "0 0 8px", whiteSpace: "pre-wrap" }, children: message }, `${message}-${index}`))
          }
        ),
